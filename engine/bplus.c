...
/*
 * record: Payload stored only in leaves. Currently just an integer value.
 * Extend this struct to attach additional attributes without changing tree
 * navigation logic.
 */
typedef struct record {
  int value;  // User data associated with key.
} record;
